...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var Types = PS["Types"];        
  var updateKeyboard = function (gameRef) {
      return function __do() {
          var v = Control_Monad_Eff_Ref.readRef(gameRef)();
          var v1 = Control_Monad_Eff_Ref.readRef(v.keyboard)();
          var newKeys = Data_Functor.map(Data_Functor.functorArray)(function (v2) {
              return new Data_Tuple.Tuple(v2.value0, false);
          })(v1);
          return Control_Monad_Eff_Ref.writeRef(v.keyboard)(newKeys)();
      };
  };
  var isJustDown$prime = function (keyboard) {
      return function (keyCode) {
          return Data_Foldable.foldl(Data_Foldable.foldableArray)(function (acc) {
              return function (v) {
                  return acc || v.value0 === keyCode && v.value1;
              };
          })(false)(keyboard);
      };
  };
  var isJustDown = function (keyRef) {
      return function (keyCode) {
          return function __do() {
              var v = Control_Monad_Eff_Ref.readRef(keyRef)();
              return isJustDown$prime(v)(keyCode);
          };
      };
  };
  var initialState = [  ];
  var initialize = function __do() {
      ...
      $foreign.onKeyDown(function (code) {
          return Control_Monad_Eff_Ref.modifyRef(v)(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ new Data_Tuple.Tuple(code, true) ]));
      })();
      $foreign.onKeyUp(function (code) {
          return Control_Monad_Eff_Ref.modifyRef(v)(Data_Array.filter(function (v1) {
              return v1.value0 !== code;
          }));
      })();
      return v;
  };
  ...
  exports["isJustDown"] = isJustDown;
  exports["updateKeyboard"] = updateKeyboard;
})(PS["Util.Keyboard"] = PS["Util.Keyboard"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var addMoreBlocksTEMP = function (gameRef) {
      return function __do() {
          var v = Control_Monad_Eff_Ref.readRef(gameRef)();
          return Control_Bind.ifM(Control_Monad_Eff.bindEff)(Util_Keyboard.isJustDown(v.keyboard)(32))(function __do() {
              var v1 = Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_Traversable.traversableArray)(Data_Array.range(0)(9))(function (i) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(new Types.Block({
                      x: Data_Int.toNumber(i) * 34.0, 
                      y: 100.0, 
                      health: 50, 
                      id: Util_Unsafe_UUID.unsafeGenUUID(Data_Unit.unit)
                  }));
              })();
              return Control_Monad_Eff_Ref.modifyRef(gameRef)(Optic_Setter.concat(Data_Semigroup.semigroupArray)(Lenses.objects(Data_Identity.functorIdentity))(v1))();
      ...
      return function (v1) {
          return function (v2) {
              if (v1 instanceof Types.Playing) {
                  return Control_Monad_Eff.foreachE([ addBlock, addMoreBlocksTEMP, movementAndCollision(v), Handlers_Destruction.removeDeadObjects, Util_Touch.updateTouches, Util_Keyboard.updateKeyboard ])(function (action) {
                      return action(v2);
                  });
              };
              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
