...
(function(exports) {
  ...
  var PowerUp = (function () {
      function PowerUp(value0) {
          this.value0 = value0;
      };
      PowerUp.create = function (value0) {
          return new PowerUp(value0);
      };
      return PowerUp;
  })();
  exports["Block"] = Block;
      ...
      return function (r2) {
          if (intersects(r1)(r2)) {
              return Data_Tuple.Tuple.create(true)({
                  ...
                  y: $$Math.abs((r1.y + r2.h / 2.0) - (r2.y + r2.h / 2.0))
              });
          };
...
(function(exports) {
  ...
  var updateObj = function (time) {
      return function (game) {
          return function (v) {
              if (v instanceof Types.Block) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(new Types.Block(v.value0));
              };
              if (v instanceof Types.Ball) {
                  var ny = v.value0.y + v.value0.vy * time;
                  var nx = v.value0.x + v.value0.vx * time;
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Types.Ball.create((function () {
                      var $12 = {};
                      for (var $13 in v.value0) {
                          if ({}.hasOwnProperty.call(v.value0, $13)) {
                              $12[$13] = v["value0"][$13];
                          };
                      };
                      $12.x = nx;
              ...
              if (v instanceof Types.PowerUp) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(v);
              };
              throw new Error("Failed pattern match at Update line 25, column 1 - line 25, column 55: " + [ time.constructor.name, game.constructor.name, v.constructor.name ]);
          };
      };
  };
          ...
          return function (v2) {
              if (v1 instanceof Types.Playing) {
                  return function __do() {
                      ...
                      var v4 = Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_Traversable.traversableArray)(v3.objects)(updateObj(v)(v3))();
                      return Control_Monad_Eff_Ref.modifyRef(v2)(Optic_Setter.set(Lenses.objects(Data_Identity.functorIdentity))(v4))();
                  };
              };
          ...
          if (v instanceof Types.Ball) {
              return function __do() {
                  ...
                  var v3 = Graphics_Canvas.arc(ctx)({
                      x: $$Math.floor(v.value0.x), 
                      y: $$Math.floor(v.value0.y), 
                      r: 15.0, 
                      start: 0.0, 
                      end: 2.0 * $$Math.pi
                  })();
          ...
          return function (height) {
              return function __do() {
                  ...
                  return __unused()((function () {
                      ...
                      throw new Error("Failed pattern match at View line 62, column 5 - line 62, column 53: " + [ v.constructor.name ]);
                  })())();
              };
          };
      };
...
(function(exports) {
  ...
  var main = function __do() {
      ...
      Util_Log.logLn(Data_Tuple.showTuple(Data_Show.showBoolean)(Util_Rect.showCoords))(Util_Rect.intersectsWithAngle(Util_Rect.rect(5.0)(0.0)(10.0)(10.0))(Util_Rect.rect(3.0)(3.0)(3.0)(3.0)))();
      Util_Log.logLn(Data_Tuple.showTuple(Data_Show.showBoolean)(Util_Rect.showCoords))(Util_Rect.intersectsWithAngle(Util_Rect.rect(3.0)(3.0)(3.0)(3.0))(Util_Rect.rect(5.0)(0.0)(10.0)(10.0)))();
